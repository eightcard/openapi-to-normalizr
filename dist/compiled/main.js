...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(specFiles, c) {
          ...
          walkResponses = function _walkResponses(paths) {
            ...
            _lodash.default.each(paths, function (operations, path) {
              _lodash.default.each(operations, function (operation, method) {
                ...
                if (operationId) {
                  console.info("no use specified operationId. path:".concat(path, ", method:").concat(method, ", operationId:").concat(operationId));
